...
class JsonParserTest {
    ...
    void testDiffWhenBothObjectsAreNull() throws JsonProcessingException {
        ...
        Map<String, Tuple3<JsonParser.@NonNull Operation, @NonNull Optional<Object>, @NonNull Optional<Object>>> result = jsonParser.diff(null, null);
    ...
    void testDiffWhenObject2IsNull() throws JsonProcessingException {
        ...
        Map<String, Tuple3<JsonParser.@NonNull Operation, @NonNull Optional<Object>, @NonNull Optional<Object>>> result = jsonParser.diff(object1, null);
    ...
    void testDiffWhenBothObjectsAreEmptyJSONObjects() throws JsonProcessingException {
        ...
        Map<String, Tuple3<JsonParser.@NonNull Operation, @NonNull Optional<Object>, @NonNull Optional<Object>>> result = jsonParser.diff(object1, object2);
