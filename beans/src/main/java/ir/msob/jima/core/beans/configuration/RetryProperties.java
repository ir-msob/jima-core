...
/**
 * The `RetryProperties` class is a simple POJO (Plain Old Java Object) that holds retry-related properties.
 ...
 * The `backoff` field is an instance of the nested `Backoff` class, which holds backoff-related properties.
 */
@Setter
@Getter
@NoArgsConstructor
...
public class RetryProperties {
     ...
     * This field holds backoff-related properties for the retry mechanism.
     */
     ...
     * It holds backoff-related properties such as `initialInterval`, `multiplier`, and `maxInterval`.
     */
    @Setter
    @Getter
    @NoArgsConstructor
