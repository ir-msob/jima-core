...
/**
 * The 'BaseRelatedActionDto' interface represents a base object validations with a set of object validations.
 ...
 */
public interface BaseObjectValidationDto<ID extends Comparable<ID> & Serializable, OV extends ObjectValidationAbstract<ID>>
