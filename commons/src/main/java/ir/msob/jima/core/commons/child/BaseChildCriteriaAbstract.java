...
public class BaseChildCriteriaAbstract<ID extends Comparable<ID> & Serializable, RM extends BaseChild<ID>> extends BaseCriteriaAbstract<ID>  implements BaseChildCriteria<ID, RM> {
