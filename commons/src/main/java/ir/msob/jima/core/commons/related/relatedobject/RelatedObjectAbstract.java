...
public abstract class RelatedObjectAbstract<ID extends Comparable<ID> & Serializable, RID extends Comparable<RID> & Serializable> extends BaseRelatedModelAbstract<ID> implements Comparable<RelatedObjectAbstract<ID, RID>> {
