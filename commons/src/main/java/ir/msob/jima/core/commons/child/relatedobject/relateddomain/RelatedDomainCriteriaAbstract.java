...
/**
 * This class represents the filters that can be applied when searching for child domains.
 * It extends the BaseRelatedFilters class and provides filters for the child domain type, ID, role, and referred type.
 *
