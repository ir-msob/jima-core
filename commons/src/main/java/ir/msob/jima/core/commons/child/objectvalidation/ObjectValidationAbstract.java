 ...
 * It extends {@link BaseElementAbstract} and implements {@link Comparable} for sorting based on the name.
 * <p>
 * Fields:
...
public abstract class ObjectValidationAbstract<ID extends Comparable<ID> & Serializable> extends BaseChildAbstract<ID> implements Comparable<ObjectValidationAbstract<ID>> {
