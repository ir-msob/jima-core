...
public abstract class BaseRelatedObjectCriteriaAbstract<ID extends Comparable<ID> & Serializable, RID extends Comparable<RID> & Serializable, CD extends BaseRelatedObject<ID, RID>> extends BaseChildCriteriaAbstract<ID, CD> implements BaseChildCriteriaRelatedId<ID, RID, CD>, BaseFilters {
