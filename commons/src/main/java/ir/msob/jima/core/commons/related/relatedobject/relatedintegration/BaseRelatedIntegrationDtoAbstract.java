...
/**
 * The 'BaseRelatedIntegrationDtoAbstract' class provides a basic implementation of the 'BaseRelatedIntegrationDto' interface.
 ...
 * The 'relatedIntegrations' field is annotated with '@Valid' to enable related integration of the related integrations.
 *
...
@NoArgsConstructor
public abstract class BaseRelatedIntegrationDtoAbstract<ID extends Comparable<ID> & Serializable, RI extends RelatedIntegrationAbstract<ID>> implements BaseRelatedIntegrationDto<ID, RI> {
    /**
