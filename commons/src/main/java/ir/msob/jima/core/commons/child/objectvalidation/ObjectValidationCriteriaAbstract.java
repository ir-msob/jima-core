...
public abstract class ObjectValidationCriteriaAbstract<ID extends Comparable<ID> & Serializable, RM extends ObjectValidationAbstract<ID>> extends BaseChildCriteriaAbstract<ID, RM> implements BaseFilters {
