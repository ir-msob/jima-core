 ...
 * It extends the 'BaseElementAbstract' class and implements the 'Comparable' interface.
...
public class Characteristic<ID extends Comparable<ID> & Serializable> extends BaseChildAbstract<ID> implements Comparable<Characteristic<ID>> {
