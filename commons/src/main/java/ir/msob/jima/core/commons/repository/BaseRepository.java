...
/**
 * The 'BaseRepository' interface defines a set of default methods for retrieving class types child to data access and domain objects in the context of a Spring Data repository.
