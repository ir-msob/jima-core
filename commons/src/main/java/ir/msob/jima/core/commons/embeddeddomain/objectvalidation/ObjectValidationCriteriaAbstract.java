...
public abstract class ObjectValidationCriteriaAbstract<ID extends Comparable<ID> & Serializable, CD extends ObjectValidationAbstract<ID>> extends BaseEmbeddedCriteriaAbstract<ID, CD> implements BaseFilters {
