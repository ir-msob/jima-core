...
public abstract class RelatedPartyCriteriaAbstract<ID extends Comparable<ID> & Serializable, RM extends RelatedPartyAbstract<ID>> extends BaseRelatedObjectCriteriaAbstract<ID, String, RM> {
