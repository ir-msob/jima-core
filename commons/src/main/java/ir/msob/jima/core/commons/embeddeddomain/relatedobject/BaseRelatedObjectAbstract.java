...
public abstract class BaseRelatedObjectAbstract<ID extends Comparable<ID> & Serializable, RID extends Comparable<RID> & Serializable> extends BaseEmbeddedDomainAbstract<ID> implements BaseRelatedObject<ID, RID> {
