...
public abstract class RelatedActionAbstract<ID extends Comparable<ID> & Serializable> extends BaseChildDomainAbstract<ID> implements Comparable<RelatedActionAbstract<ID>> {
