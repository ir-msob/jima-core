...
import ir.msob.jima.core.commons.embeddeddomain.relatedobject.relatedparty.RelatedPartyCriteriaAbstract;
...
public abstract class AuditDomainCriteriaAbstract<ID extends Comparable<ID> & Serializable, RP extends RelatedPartyAbstract<ID>, RPF extends RelatedPartyCriteriaAbstract<ID, RP>, RM extends AuditDomainAbstract<ID, RP>> extends BaseEmbeddedCriteriaAbstract<ID, RM> implements BaseFilters {
    /**
