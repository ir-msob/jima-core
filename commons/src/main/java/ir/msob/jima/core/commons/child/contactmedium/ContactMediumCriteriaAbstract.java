...
public class ContactMediumCriteriaAbstract<ID extends Comparable<ID> & Serializable, RM extends ContactMediumAbstract<ID>> extends BaseChildCriteriaAbstract<ID, RM> implements BaseFilters {
