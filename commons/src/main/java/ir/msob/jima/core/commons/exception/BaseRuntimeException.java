...
/**
 * A base class for runtime exceptions in the application.
 * This class extends {@link RuntimeException} and provides constructors
 * for creating exceptions with various levels of detail.
 */
public class BaseRuntimeException extends RuntimeException {
     ...
     * (which typically contains the class and detail message of {@code cause}). This constructor is useful for runtime exceptions
