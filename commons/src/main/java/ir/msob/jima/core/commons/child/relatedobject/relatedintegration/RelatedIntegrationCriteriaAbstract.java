...
/**
 * This class represents the filters that can be applied when searching for child integrations.
 * It extends the BaseRelatedFilters class and provides filters for the child integration type, ID, role, and referred type.
 */
@Setter
@Getter
@NoArgsConstructor
