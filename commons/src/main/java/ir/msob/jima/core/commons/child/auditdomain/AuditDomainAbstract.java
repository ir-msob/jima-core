 ...
 * It includes fields for the child party ID, action date, action type, and version.
...
@NoArgsConstructor
@AllArgsConstructor
public abstract class AuditDomainAbstract<ID extends Comparable<ID> & Serializable, RP extends RelatedPartyAbstract<ID>> extends BaseChildAbstract<ID> implements Comparable<AuditDomainAbstract<ID, RP>> {
    /**
     * The child party.
     */
    @NotNull
