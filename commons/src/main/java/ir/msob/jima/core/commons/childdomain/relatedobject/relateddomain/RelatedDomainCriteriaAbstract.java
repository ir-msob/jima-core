...
/**
 * This class represents the filters that can be applied when searching for childdomain domains.
 * It extends the BaseRelatedFilters class and provides filters for the childdomain domain type, ID, role, and referred type.
 *
