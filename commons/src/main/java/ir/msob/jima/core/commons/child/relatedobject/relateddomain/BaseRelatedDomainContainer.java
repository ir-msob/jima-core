...
/**
 * The 'BaseRelatedDomainContainer' interface defines the basic structure for a child domain in the application.
 ...
 */
public interface BaseRelatedDomainContainer<ID extends Comparable<ID> & Serializable, RD extends RelatedDomainAbstract<ID>> extends BaseContainer {
