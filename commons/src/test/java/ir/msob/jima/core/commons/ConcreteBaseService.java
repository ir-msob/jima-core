...
public class ConcreteBaseService extends SampleService<String, ConcreteBaseUser, SampleDomain<String>, SampleDto<String>, SampleCriteria<String>, SampleRepository<String, SampleDomain<String>>> {
}
