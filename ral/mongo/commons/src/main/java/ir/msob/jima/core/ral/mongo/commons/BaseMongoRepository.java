...
public interface BaseMongoRepository<ID extends Comparable<ID> & Serializable, D extends BaseDomain<ID>> extends
     ...
     */
    @MethodStats
    default Mono<@NonNull D> findOne(MongoQuery mongoQuery) {
     ...
     */
    @MethodStats
    default Mono<@NonNull D> findOneAndModify(MongoQuery mongoQuery, MongoUpdate mongoUpdate) {
     ...
     */
    @MethodStats
    default Mono<@NonNull D> modifyAndFindOne(MongoQuery mongoQuery, MongoUpdate mongoUpdate) {
        return getReactiveMongoTemplate().findAndModify(mongoQuery.getQuery(), mongoUpdate.getUpdate(),
     ...
     */
    @MethodStats
    default Mono<@NonNull Page<D>> findPage(MongoQuery mongoQuery) {
     ...
     */
    @MethodStats
    default Mono<@NonNull Boolean> exists(MongoQuery mongoQuery) {
     ...
     */
    @MethodStats
    default Mono<@NonNull Boolean> existsNot(MongoQuery mongoQuery) {
     ...
     */
    @MethodStats
    default Mono<@NonNull Boolean> updateFirst(MongoQuery mongoQuery, MongoUpdate mongoUpdate) {
     ...
     */
    @MethodStats
    default Mono<@NonNull Boolean> upsert(MongoQuery mongoQuery, MongoUpdate mongoUpdate) {
     ...
     */
    @MethodStats
    default Mono<@NonNull Boolean> updateMulti(MongoQuery mongoQuery, MongoUpdate mongoUpdate) {
     ...
     */
    @MethodStats
    default Mono<@NonNull Boolean> delete(MongoQuery mongoQuery) {
     ...
     */
    @MethodStats
    default Flux<@NonNull D> findAndRemove(MongoQuery mongoQuery) {
     ...
     */
    @MethodStats
    default Mono<@NonNull D> findOneAndRemove(MongoQuery mongoQuery) {
